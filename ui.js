...
ui.setPredictedClass = function(classId) {
  if (classId == 0)
  {
  	predictedClassElement.innerText = "positive";
	predictedClassElement.style.color = 'green';
  }
  else
  {
	predictedClassElement.innerText = "negative";
	predictedClassElement.style.color = 'red	';
  }
}
...
/* leftButton.addEventListener('mousedown', () => ui.handler(0));
leftButton.addEventListener('mouseup', () => mouseDown = false);

rightButton.addEventListener('mousedown', () => ui.handler(1));
